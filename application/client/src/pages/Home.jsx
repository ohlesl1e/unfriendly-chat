      ...
      { userSession && userSession.username ? (
        ...
        <div class="px-4 py-5 my-5 text-center">
          ...
          <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">Securing Network communications using the Signal Protocol.</p>
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
              <a class="btn btn-outline-secondary me-3 btn-lg px-4 gap-3" href='/login'>Log In</a>
              <a class="btn btn-primary btn-lg px-4" href='/signup'>Sign Up</a>
            </div>
          </div>
        </div>
        )
